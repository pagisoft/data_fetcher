...
public class UserIncomingPaymentStruct  implements java.io.Serializable {
    ...
    private com.pagisoft.datafetcher.soap.model.PaymentDetailsStruct[] payTransDetails;
    ...
    public UserIncomingPaymentStruct(
           ...
           com.pagisoft.datafetcher.soap.model.PaymentDetailsStruct[] payTransDetails,
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PaymentDetailsStruct[] getPayTransDetails() {
        return payTransDetails;
    }
     ...
     */
    public void setPayTransDetails(com.pagisoft.datafetcher.soap.model.PaymentDetailsStruct[] payTransDetails) {
        this.payTransDetails = payTransDetails;
    }
