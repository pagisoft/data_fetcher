...
public class DoGetMyPayoutsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.UserPayoutStruct[] payTransPayout;

    public DoGetMyPayoutsResponse() {
    }

    public DoGetMyPayoutsResponse(
           com.pagisoft.datafetcher.soap.model.UserPayoutStruct[] payTransPayout) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.UserPayoutStruct[] getPayTransPayout() {
        return payTransPayout;
    }
     ...
     */
    public void setPayTransPayout(com.pagisoft.datafetcher.soap.model.UserPayoutStruct[] payTransPayout) {
        this.payTransPayout = payTransPayout;
    }
