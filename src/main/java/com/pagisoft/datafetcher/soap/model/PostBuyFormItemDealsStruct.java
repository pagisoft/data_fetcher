...
public class PostBuyFormItemDealsStruct  implements java.io.Serializable {
    ...
    private com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsVariantStruct dealVariant;

    private com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsAdditionalServiceStruct[] dealAdditionalServices;
    ...
    public PostBuyFormItemDealsStruct(
           ...
           com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsVariantStruct dealVariant,
           com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsAdditionalServiceStruct[] dealAdditionalServices) {
           this.dealId = dealId;
     ...
     * @return dealVariant
     */
    public com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsVariantStruct getDealVariant() {
        return dealVariant;
    }
     ...
     * @param dealVariant
     */
    public void setDealVariant(com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsVariantStruct dealVariant) {
        this.dealVariant = dealVariant;
    }
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsAdditionalServiceStruct[] getDealAdditionalServices() {
        return dealAdditionalServices;
    }
     ...
     */
    public void setDealAdditionalServices(com.pagisoft.datafetcher.soap.model.PostBuyFormItemDealsAdditionalServiceStruct[] dealAdditionalServices) {
        this.dealAdditionalServices = dealAdditionalServices;
    }
        ...
        _equals = true && 
            ...
            ((this.dealAdditionalServices==null && other.getDealAdditionalServices()==null) || 
             (this.dealAdditionalServices!=null &&
              java.util.Arrays.equals(this.dealAdditionalServices, other.getDealAdditionalServices())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDealAdditionalServices() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDealAdditionalServices());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDealAdditionalServices(), i);
                if (obj != null &&
