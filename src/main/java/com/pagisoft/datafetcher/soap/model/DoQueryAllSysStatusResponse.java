...
public class DoQueryAllSysStatusResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.SysStatusType[] sysCountryStatus;

    public DoQueryAllSysStatusResponse() {
    }

    public DoQueryAllSysStatusResponse(
           com.pagisoft.datafetcher.soap.model.SysStatusType[] sysCountryStatus) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.SysStatusType[] getSysCountryStatus() {
        return sysCountryStatus;
    }
     ...
     */
    public void setSysCountryStatus(com.pagisoft.datafetcher.soap.model.SysStatusType[] sysCountryStatus) {
        this.sysCountryStatus = sysCountryStatus;
    }
