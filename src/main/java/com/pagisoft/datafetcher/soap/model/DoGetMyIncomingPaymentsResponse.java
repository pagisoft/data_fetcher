...
public class DoGetMyIncomingPaymentsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.UserIncomingPaymentStruct[] payTransIncome;

    public DoGetMyIncomingPaymentsResponse() {
    }

    public DoGetMyIncomingPaymentsResponse(
           com.pagisoft.datafetcher.soap.model.UserIncomingPaymentStruct[] payTransIncome) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.UserIncomingPaymentStruct[] getPayTransIncome() {
        return payTransIncome;
    }
     ...
     */
    public void setPayTransIncome(com.pagisoft.datafetcher.soap.model.UserIncomingPaymentStruct[] payTransIncome) {
        this.payTransIncome = payTransIncome;
    }
