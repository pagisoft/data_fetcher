...
public class DoGetMyPaymentsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.UserPaymentStruct[] payTransPayment;

    public DoGetMyPaymentsResponse() {
    }

    public DoGetMyPaymentsResponse(
           com.pagisoft.datafetcher.soap.model.UserPaymentStruct[] payTransPayment) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.UserPaymentStruct[] getPayTransPayment() {
        return payTransPayment;
    }
     ...
     */
    public void setPayTransPayment(com.pagisoft.datafetcher.soap.model.UserPaymentStruct[] payTransPayment) {
        this.payTransPayment = payTransPayment;
    }
