...
public class DoGetBlackListUsersResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.BlackListStruct[] blackListUsers;

    public DoGetBlackListUsersResponse() {
    }

    public DoGetBlackListUsersResponse(
           com.pagisoft.datafetcher.soap.model.BlackListStruct[] blackListUsers) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.BlackListStruct[] getBlackListUsers() {
        return blackListUsers;
    }
     ...
     */
    public void setBlackListUsers(com.pagisoft.datafetcher.soap.model.BlackListStruct[] blackListUsers) {
        this.blackListUsers = blackListUsers;
    }
