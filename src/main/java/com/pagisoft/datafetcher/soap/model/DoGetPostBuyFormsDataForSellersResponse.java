...
public class DoGetPostBuyFormsDataForSellersResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.PostBuyFormDataStruct[] postBuyFormData;

    public DoGetPostBuyFormsDataForSellersResponse() {
    }

    public DoGetPostBuyFormsDataForSellersResponse(
           com.pagisoft.datafetcher.soap.model.PostBuyFormDataStruct[] postBuyFormData) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PostBuyFormDataStruct[] getPostBuyFormData() {
        return postBuyFormData;
    }
     ...
     */
    public void setPostBuyFormData(com.pagisoft.datafetcher.soap.model.PostBuyFormDataStruct[] postBuyFormData) {
        this.postBuyFormData = postBuyFormData;
    }
