...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements com.pagisoft.datafetcher.soap.model.ServiceService {
    ...
    public com.pagisoft.datafetcher.soap.model.ServicePort_PortType getservicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.pagisoft.datafetcher.soap.model.ServicePort_PortType getservicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.pagisoft.datafetcher.soap.model.ServiceBindingStub _stub = new com.pagisoft.datafetcher.soap.model.ServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.pagisoft.datafetcher.soap.model.ServicePort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.pagisoft.datafetcher.soap.model.ServiceBindingStub _stub = new com.pagisoft.datafetcher.soap.model.ServiceBindingStub(new java.net.URL(servicePort_address), this);
                _stub.setPortName(getservicePortWSDDServiceName());
                return _stub;
            }
        }
