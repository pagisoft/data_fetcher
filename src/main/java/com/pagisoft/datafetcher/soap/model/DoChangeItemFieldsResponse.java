...
public class DoChangeItemFieldsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.ChangedItemStruct changedItem;

    public DoChangeItemFieldsResponse() {
    }

    public DoChangeItemFieldsResponse(
           com.pagisoft.datafetcher.soap.model.ChangedItemStruct changedItem) {
     ...
     * @return changedItem
     */
    public com.pagisoft.datafetcher.soap.model.ChangedItemStruct getChangedItem() {
        return changedItem;
    }
     ...
     * @param changedItem
     */
    public void setChangedItem(com.pagisoft.datafetcher.soap.model.ChangedItemStruct changedItem) {
        this.changedItem = changedItem;
    }
