...
public class DoGetMyIncomingPaymentsRefundsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds;

    public DoGetMyIncomingPaymentsRefundsResponse() {
    }

    public DoGetMyIncomingPaymentsRefundsResponse(
           com.pagisoft.datafetcher.soap.model.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.UserIncomingPaymentRefundsStruct[] getPayTransIncomeRefunds() {
        return payTransIncomeRefunds;
    }
     ...
     */
    public void setPayTransIncomeRefunds(com.pagisoft.datafetcher.soap.model.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds) {
        this.payTransIncomeRefunds = payTransIncomeRefunds;
    }
