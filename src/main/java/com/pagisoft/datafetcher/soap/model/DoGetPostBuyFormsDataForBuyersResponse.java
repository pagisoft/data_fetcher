...
public class DoGetPostBuyFormsDataForBuyersResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers;

    public DoGetPostBuyFormsDataForBuyersResponse() {
    }

    public DoGetPostBuyFormsDataForBuyersResponse(
           com.pagisoft.datafetcher.soap.model.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PostBuyFormForBuyersDataStruct[] getPostBuyFormDataForBuyers() {
        return postBuyFormDataForBuyers;
    }
     ...
     */
    public void setPostBuyFormDataForBuyers(com.pagisoft.datafetcher.soap.model.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
        this.postBuyFormDataForBuyers = postBuyFormDataForBuyers;
    }
