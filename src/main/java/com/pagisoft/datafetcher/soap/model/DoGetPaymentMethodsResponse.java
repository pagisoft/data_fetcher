...
public class DoGetPaymentMethodsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.PaymentMethodStruct[] paymentMethods;

    public DoGetPaymentMethodsResponse() {
    }

    public DoGetPaymentMethodsResponse(
           com.pagisoft.datafetcher.soap.model.PaymentMethodStruct[] paymentMethods) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PaymentMethodStruct[] getPaymentMethods() {
        return paymentMethods;
    }
     ...
     */
    public void setPaymentMethods(com.pagisoft.datafetcher.soap.model.PaymentMethodStruct[] paymentMethods) {
        this.paymentMethods = paymentMethods;
    }
