...
public class DoGetCategoryPathResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.CategoryData[] categoryPath;

    public DoGetCategoryPathResponse() {
    }

    public DoGetCategoryPathResponse(
           com.pagisoft.datafetcher.soap.model.CategoryData[] categoryPath) {
     ...
     * @return categoryPath
     */
    public com.pagisoft.datafetcher.soap.model.CategoryData[] getCategoryPath() {
        return categoryPath;
    }
     ...
     * @param categoryPath
     */
    public void setCategoryPath(com.pagisoft.datafetcher.soap.model.CategoryData[] categoryPath) {
        this.categoryPath = categoryPath;
    }
