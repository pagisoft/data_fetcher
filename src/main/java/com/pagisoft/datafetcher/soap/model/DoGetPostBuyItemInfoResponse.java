...
public class DoGetPostBuyItemInfoResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.PostBuyItemInfoStruct[] itemPostBuyFormInfo;

    public DoGetPostBuyItemInfoResponse() {
    }

    public DoGetPostBuyItemInfoResponse(
           com.pagisoft.datafetcher.soap.model.PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PostBuyItemInfoStruct[] getItemPostBuyFormInfo() {
        return itemPostBuyFormInfo;
    }
     ...
     */
    public void setItemPostBuyFormInfo(com.pagisoft.datafetcher.soap.model.PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
        this.itemPostBuyFormInfo = itemPostBuyFormInfo;
    }
