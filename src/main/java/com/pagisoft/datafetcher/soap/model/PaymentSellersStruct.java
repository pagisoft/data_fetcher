...
public class PaymentSellersStruct  implements java.io.Serializable {
    ...
    private com.pagisoft.datafetcher.soap.model.PaymentItemsStruct[] payTransItems;
    ...
    public PaymentSellersStruct(
           ...
           com.pagisoft.datafetcher.soap.model.PaymentItemsStruct[] payTransItems,
     ...
     */
    public com.pagisoft.datafetcher.soap.model.PaymentItemsStruct[] getPayTransItems() {
        return payTransItems;
    }
     ...
     * @param payTransItems
     */
    public void setPayTransItems(com.pagisoft.datafetcher.soap.model.PaymentItemsStruct[] payTransItems) {
        this.payTransItems = payTransItems;
    }
