...
public class DoGetCountriesResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.CountryInfoType[] countryArray;

    public DoGetCountriesResponse() {
    }

    public DoGetCountriesResponse(
           com.pagisoft.datafetcher.soap.model.CountryInfoType[] countryArray) {
     ...
     * @return countryArray
     */
    public com.pagisoft.datafetcher.soap.model.CountryInfoType[] getCountryArray() {
        return countryArray;
    }
     ...
     * @param countryArray
     */
    public void setCountryArray(com.pagisoft.datafetcher.soap.model.CountryInfoType[] countryArray) {
        this.countryArray = countryArray;
    }
