...
public class DoGetSiteJournalResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.SiteJournal[] siteJournalArray;

    public DoGetSiteJournalResponse() {
    }

    public DoGetSiteJournalResponse(
           com.pagisoft.datafetcher.soap.model.SiteJournal[] siteJournalArray) {
     ...
     */
    public com.pagisoft.datafetcher.soap.model.SiteJournal[] getSiteJournalArray() {
        return siteJournalArray;
    }
     ...
     */
    public void setSiteJournalArray(com.pagisoft.datafetcher.soap.model.SiteJournal[] siteJournalArray) {
        this.siteJournalArray = siteJournalArray;
    }
