...
public class DoAddPackageInfoToPostBuyFormRequest  implements java.io.Serializable {
    ...
    private com.pagisoft.datafetcher.soap.model.PackageInfoStruct[] packageInfo;
    ...
    public DoAddPackageInfoToPostBuyFormRequest(
           ...
           long transactionId,
           com.pagisoft.datafetcher.soap.model.PackageInfoStruct[] packageInfo) {
     ...
     * @return packageInfo
     */
    public com.pagisoft.datafetcher.soap.model.PackageInfoStruct[] getPackageInfo() {
        return packageInfo;
    }
     ...
     * @param packageInfo
     */
    public void setPackageInfo(com.pagisoft.datafetcher.soap.model.PackageInfoStruct[] packageInfo) {
        this.packageInfo = packageInfo;
    }
