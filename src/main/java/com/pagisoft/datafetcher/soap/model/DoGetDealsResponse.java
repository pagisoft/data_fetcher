...
public class DoGetDealsResponse  implements java.io.Serializable {
    private com.pagisoft.datafetcher.soap.model.DealsStruct[] dealsList;

    public DoGetDealsResponse() {
    }

    public DoGetDealsResponse(
           com.pagisoft.datafetcher.soap.model.DealsStruct[] dealsList) {
     ...
     * @return dealsList
     */
    public com.pagisoft.datafetcher.soap.model.DealsStruct[] getDealsList() {
        return dealsList;
    }
     ...
     * @param dealsList
     */
    public void setDealsList(com.pagisoft.datafetcher.soap.model.DealsStruct[] dealsList) {
        this.dealsList = dealsList;
    }
